...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TheCash Core thecash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  thecash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thecash transaction") + "\n" +
                               "  thecash-tx [options] -create [commands]   " + _("Create hex-encoded thecash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded thecash transaction
