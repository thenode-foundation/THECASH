...
/** Utility functions used by the TheCash Qt UI.
 */
namespace GUIUtil
{
...
// Render TheCash addresses in monospace font
...
// Parse "thecash:" URI into recipient object, return true on successful parsing
