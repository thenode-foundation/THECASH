                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received TCH from zTCH"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTCH"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTCH));
