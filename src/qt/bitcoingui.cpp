...
spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TheCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TheCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TheCash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTCH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TheCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about TheCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TheCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TheCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TheCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a TheCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TheCash Core help message to get a list with possible TheCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TheCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TheCash network", "", count));
}
...
{
    QString strTitle = tr("TheCash Core"); // default title
