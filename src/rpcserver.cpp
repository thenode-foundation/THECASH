...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "TheCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TheCash features */
        {"thecash", "masternode", &masternode, true, true, false},
        {"thecash", "listmasternodes", &listmasternodes, true, true, false},
        {"thecash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thecash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thecash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thecash", "masternodedebug", &masternodedebug, true, true, false},
        {"thecash", "startmasternode", &startmasternode, true, true, false},
        {"thecash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thecash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thecash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thecash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thecash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thecash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thecash", "mnbudget", &mnbudget, true, true, false},
        {"thecash", "preparebudget", &preparebudget, true, true, false},
        {"thecash", "submitbudget", &submitbudget, true, true, false},
        {"thecash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thecash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thecash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thecash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thecash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thecash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thecash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thecash", "checkbudgets", &checkbudgets, true, true, false},
        {"thecash", "mnsync", &mnsync, true, true, false},
        {"thecash", "spork", &spork, true, true, false},
        {"thecash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"thecash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thecashd, or the -server option to thecash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thecash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48592/\n";
}
