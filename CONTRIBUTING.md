Contributing to TheCash Core
============================

The TheCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TheCash Core project, and is not to be
confused with overall TheCash Network Protocol consensus changes.

Whether a pull request is merged into TheCash Core rests with the project merge
...
Patches that change TheCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the TheCash consensus, it must have been
...
The project leader is the release manager for each TheCash Core release.
