...
In order to support loading of multiple wallets in thecash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thecash.cpp.
...
Changes to thecash.cpp
----------------------
thecash.cpp is the entry point into thecash-qt, and as such, will require some minor modifications to provide hooks for
