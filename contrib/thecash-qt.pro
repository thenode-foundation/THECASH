...
RESOURCES += src/qt/thecash.qrc src/qt/thecash_locale.qrc

TRANSLATIONS += src/qt/locale/thecash_bg.ts \
                src/qt/locale/thecash_de.ts \
                src/qt/locale/thecash_en.ts \
                src/qt/locale/thecash_es.ts \
                src/qt/locale/thecash_fi.ts \
                src/qt/locale/thecash_fr.ts \
                src/qt/locale/thecash_it.ts \
                src/qt/locale/thecash_ja.ts \
                src/qt/locale/thecash_pl.ts \
                src/qt/locale/thecash_pt.ts \
                src/qt/locale/thecash_ru.ts \
                src/qt/locale/thecash_sk.ts \
                src/qt/locale/thecash_sv.ts \
                src/qt/locale/thecash_vi.ts \
                src/qt/locale/thecash_zh_CN.ts \
                src/qt/locale/thecash_zh_TW.ts
